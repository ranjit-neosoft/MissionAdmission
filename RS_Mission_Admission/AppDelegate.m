...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    tabBarController = (UITabBarController *)[Utils instantiateViewControllerWithId:@"HomeTab"];
    ...
    [self.window setBackgroundColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"packing-backpack.jpg"]]];
