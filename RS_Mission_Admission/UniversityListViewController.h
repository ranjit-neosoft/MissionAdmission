...
@interface UniversityListViewController : BaseViewController <UISearchBarDelegate, NSURLConnectionDataDelegate, UITableViewDataSource, UITableViewDelegate,UIAlertViewDelegate>
{
